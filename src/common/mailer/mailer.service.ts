...
export class Mailer {
  ...
  //passcode email for super admin 
  ...
  async updatePasscodeMail(
    ...
    const subject = 'Passcode Update for SuperAdmin of The Gearmates';
    const content = `<!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8">
    ...
    <body>
      <div class="container">
        ...
        <h1 class="heading">Dear ${name},</h1>
        <p class="message">Your new passcode for extremely sensitive and secured operations within the admin dashboard as a superadmin is:</p>
