      ...
      try {
        ...
        if (error instanceof NotFoundException)
          ...
          throw new InternalServerErrorException(
            'something went wrong while trying to update admin profile ',error.message
          );
        }
      }
    }
    ...
    async DeleteUserAccount(dto: confirmDeleteAccountDto, admin: AdminEntity) {
      try {
        ...
        if (error instanceof NotAcceptableException)
          ...
          console.log(error);
          throw new InternalServerErrorException(
            'something went wrong while trying to delete admin account, please try again later',error.message
          );
        }
      }
    }
